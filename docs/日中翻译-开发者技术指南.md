...
| **测试** | 不存在 | 218 单测 + 6 E2E + LLM-as-Judge benchmark |
...
# 下载 Sakura-Galtransl-14B-v3.8-Q4_K_M.gguf (~8.5GB)
...
# 218 tests, 全部通过
```
详细测试覆盖清单（逐文件用例数）见 [CONTEXT.md](../CONTEXT.md#测试总览2026-07-05)。
...
| [日中翻译-迭代报告](./日中翻译-迭代报告.md) | 开发者 | 15 个迭代的完整开发历史 |
